...
cc <- create_accum_cost(x = slope_cs, origins = locs_tess2000, FUN = mean, rescale = FALSE)
plot(cc, main='accumulated cost raster, DEM = 10agg, tobler, neighbor = 4, tess2000km')
cc
writeRaster(cc, "./Paige_Attempt/output/Acc_DEMagg10_tobl_neighb4_2000km.tif")
